    ...
    <div className="relative w-full h-[100px] min-h-[100px] px-8 gradient-header flex justify-center items-center">
      <div className="w-full max-w-[1300px] h-full flex justify-between items-center border-b border-white/6">
        ...
        <div className="relative mr-1.5 w-[170px] min-w-[170px] h-10 rounded-[40px] bg-[#121a2e] flex items-center transition-all duration-300 cursor-pointer hover:opacity-70">
          <div className="w-10 h-10 rounded-[40px] bg-gradient-to-br from-[#4E95FF] to-[#376FFF] flex justify-center items-center mr-2.5">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
            ...
            >
              <path
                d="M8 1L11 4H9V9H7V4H5L8 1ZM3 11V13H13V11H15V13C15 14.1 14.1 15 13 15H3C1.9 15 1 14.1 1 13V11H3Z"
                fill="white"
              />
            </svg>
          </div>
          ...
          <div className="flex justify-center items-center gap-2">
            ...
            <div className="ml-1 flex flex-col gap-1">
              ...
              <div className="whitespace-nowrap font-bold text-lg leading-5 text-white">
                2,524<span className="opacity-25"> pts</span>
              </div>
            </div>

            {/* Upload Button */}
            <button className="bg-gradient-to-r from-[#4E95FF] to-[#376FFF] h-12 mx-2.5 px-4 rounded-xl flex items-center gap-3 font-bold text-sm text-white transition-all duration-300 hover:opacity-70">
              <svg
                width="18"
                height="18"
                viewBox="0 0 18 18"
                  ...
                  <div className="w-full max-h-[270px] overflow-y-auto pr-2.5">
                      ...
                      <div className="relative w-full p-5 pr-[60px] bg-[#0d1529]">
                        ...
                        <div className="pl-[60px]">
                          ...
                          <div className="font-bold text-sm text-[#5f6889] word-break">
                            Start exploring our vast collection of Minecraft
                            resources. Upload your own content to earn points
                            and unlock VIP features!
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-full flex flex-col justify-center items-center gap-3">
                      ...
                      <span className="font-bold text-sm leading-[17px] text-[#5f6889]/30">
                        These are all your notifications
                      </span>
                    </div>
                  </div>
                </div>
